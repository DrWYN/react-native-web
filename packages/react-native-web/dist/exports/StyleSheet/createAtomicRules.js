  ...
  switch (prop) {
      ...
      if (value === 'auto' || value === 'box-only') {
        ...
        if (value === 'box-only') {
          ...
          var _block = (0, _createRuleBlock8.default)(
            ((_createRuleBlock = {}), (_createRuleBlock[prop] = 'none'), _createRuleBlock)
          );
        ...
        if (value === 'box-none') {
          ...
          var _block2 = (0, _createRuleBlock8.default)(
            ((_createRuleBlock2 = {}), (_createRuleBlock2[prop] = 'auto'), _createRuleBlock2)
          );
          rules.push(selector + ' > *{' + _block2 + '}');
        }
      }
      var block = (0, _createRuleBlock8.default)(
        ((_createRuleBlock3 = {}), (_createRuleBlock3[prop] = val), _createRuleBlock3)
      );
    ...
    case 'animationName': {
      if (typeof value === 'string') {
        ...
        var _block4 = (0, _createRuleBlock8.default)(
          ((_createRuleBlock4 = {}), (_createRuleBlock4[prop] = value), _createRuleBlock4)
        );
    ...
    default: {
      ...
      var _block6 = (0, _createRuleBlock8.default)(
        ((_createRuleBlock6 = {}), (_createRuleBlock6[prop] = value), _createRuleBlock6)
      );
